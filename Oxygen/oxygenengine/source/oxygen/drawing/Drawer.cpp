...
void Drawer::drawSprite(Vec2i position, uint64 spriteKey, const Color& tintColor)
{
	mDrawCollection.addDrawCommand(DrawCommand::mFactory.mSpriteDrawCommands.createObject(position, spriteKey, tintColor));
}
