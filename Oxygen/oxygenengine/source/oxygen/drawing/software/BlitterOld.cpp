...
namespace blitterinternal
{
	...
	void blitColorWithBlending(BitmapViewMutable<uint32>& destBitmap, Recti destRect, uint16 multiplicator, const uint16* additions)
	{
	...
	void blitBitmap(BitmapViewMutable<uint32>& destBitmap, Vec2i destPosition, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, uint32 tintColor)
	{
	...
	template<bool USE_TINT_COLOR>
	void blitBitmapWithBlending(BitmapViewMutable<uint32>& destBitmap, Vec2i destPosition, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, uint32 tintColor)
	{
		const uint32* srcBase = sourceBitmap.getPixelPointer(sourceRect.x, sourceRect.y);
		uint32* dstBase = destBitmap.getPixelPointer(destPosition.x, destPosition.y);
	...
	void blitBitmapWithScaling(BitmapViewMutable<uint32>& destBitmap, Recti destRect, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, uint32 tintColor)
	{
	...
	template<bool ALPHA_BLENDING, bool USE_TINT_COLOR>
	void blitBitmapWithUVs(BitmapViewMutable<uint32>& destBitmap, Recti destRect, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, uint32 tintColor)
	{
		if (destBitmap.isEmpty() || sourceRect.isEmpty())
			return;
...
void BlitterOld::blitColor(BitmapViewMutable<uint32>& destBitmap, Recti destRect, const Color& color, const Options& options)
{
	destRect.intersect(Recti(Vec2i(), destBitmap.getSize()));
	if (destRect.isEmpty())
		return;
...
void BlitterOld::blitBitmap(BitmapViewMutable<uint32>& destBitmap, Vec2i destPosition, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, const Options& options)
{
...
void BlitterOld::blitBitmapWithScaling(BitmapViewMutable<uint32>& destBitmap, Recti destRect, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, const Options& options)
{
	if (destBitmap.isEmpty() || sourceRect.isEmpty())
		return;
...
void BlitterOld::blitBitmapWithUVs(BitmapViewMutable<uint32>& destBitmap, Recti destRect, const BitmapViewMutable<uint32>& sourceBitmap, Recti sourceRect, const Options& options)
{
	if (destBitmap.isEmpty() || sourceRect.isEmpty())
		return;
